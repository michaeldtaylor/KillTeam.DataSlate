    ...
    public List<HpbProperty> Parse(string contentArea)
    {
        ...
        foreach (var tableNode in tableNodes)
        {
            ...
            foreach (var trNode in trNodes)
            {
                ...
                var propertyTypeTrNode = propertyTypeTrNodes.SingleOrDefault(p => p.ChildNodes[1].InnerText == HpbHelpers.GetTextFromSearchBedrooms(_hpbScraperOptions.SearchBedrooms));
