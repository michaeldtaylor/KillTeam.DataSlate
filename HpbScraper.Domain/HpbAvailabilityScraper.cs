...
namespace HpbScraper.Domain
{
    public class HpbAvailabilityScraper
    {
        ...
        public async Task ExecuteAsync(string outputPath)
        {
            ...
            {
                Headless = _hpbScraperOptions.Headless,
            };
            ...
            else
            {
                ...
                _hpbPropertyHtmlWriter.Write(Path.Combine(outputPath, $"HpbScraper-{DateTime.Now:yyyy-MM-dd-hh-mm-ss}.html"), hpbPropertyMap);
            }
        }
        ...
        private async Task ConfigureSearchFilter(IPage page)
        {
            ...
            if (_hpbScraperOptions.ShortNotice == true)
            {
